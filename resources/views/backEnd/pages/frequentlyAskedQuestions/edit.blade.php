                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <!-- form start -->
                            <form action="{{ route('frequently-asked-questions.update', $frequentlyAskedQuestion->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="question" value="{{ $frequentlyAskedQuestion?->question ?? '' }}" id="question" class="form-control" placeholder="Enter Question ">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="order" value="{{ $frequentlyAskedQuestion?->order ?? '' }}" id="order" class="form-control" placeholder="Enter Order ">
                                                @if($errors->has('order'))
                                        ...
                                        <div class="col-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="answer" class="form-control" name="answer" rows="3" placeholder="Write an answer">{{ $frequentlyAskedQuestion?->answer ?? '' }}</textarea>
